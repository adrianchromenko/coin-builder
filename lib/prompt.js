 ...
 */
function buildDescribedPrompt({ purpose, style, description, sideName = 'front', hasLogo = false, referenceCount = 0, feedback = '' }) {
  ...
  sections.push(
    ...
    + 'so getting those exactly right matters more than anything else in the image.'
    + (hasLogo
      ? "\nIMAGE 1 is the customer's own logo or artwork. Reproduce it exactly: the same shapes, proportions, arrangement, colors and any lettering inside it. "

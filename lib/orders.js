...
// DATA_DIR points saved files at a persistent disk on hosts that wipe the app folder on each deploy
const ORDERS_DIR = path.join(process.env.DATA_DIR || path.join(__dirname, '..'), 'orders');

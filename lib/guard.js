...
const PER_HOUR = () => num('RENDERS_PER_HOUR', 6);
const PER_DAY = () => num('RENDERS_PER_DAY', 15);
...
/**
 * Decide whether this visitor may spend a render right now. On success the render is counted immediately
